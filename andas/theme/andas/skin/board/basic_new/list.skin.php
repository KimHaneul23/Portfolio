...
<div id="ScrollWrap" style="position:relative; width:<?php echo $width; ?>;">
		...
		<span class="B_Icon" id="CheckBox_Option" data-board-wenk="선택/관리" data-board-wenk-pos="left" title="게시물 선택/관리">
			...
			<?php if ($is_checkbox) { ?>	
				<ul class="CheckBox_Option_List">
					<li><button type="submit" name="btn_submit" onclick="javascript:void(0);" id="CheckBox_CheckAll"><span class="material-icons-outlined">checklist_rtl</span> 전체선택</button></li>
...
<?php if ($is_checkbox) { ?>
<button type="submit" name="btn_submit" onclick="javascript:void(0);" id="CheckBox_CheckAll">전체선택</button>
<?php } ?>
...
<div class="ListItemWrap <?php echo $ListIngClass; ?>">
	...
	<div class="ListItem <?php echo $ListIngClass; ?>">
		<div class="is_checkbox">
			<?php if ($is_checkbox) { ?>
			<span class="material-icons List_Check_icon" data-no="<?php echo $list[$i]['wr_id'] ?>">선택</span>
...
//                echo $list[$i]['num'];
		...
		<div class="ContentWrap">
			...
			<div class="SubjectWrap"><a href="<?php echo $list[$i]['href'] ?>"><?php echo $list[$i]['subject'] ?> - <?php echo $list[$i]['wr_name'] ?></a></div>
		</div>
		...
		<div class="InfoWrap">
			<div class="WrInfo">
				<i class="fa fa-user"></i> <?php echo $list[$i]['wr_name'] ?>
			...
			<div class="ContentInfo">
				...
				<?php if ($list[$i]['wr_name']) {?><span class="material-icons-outlined NoOn" data-board-wenk="TAG가 존재합니다." data-board-wenk-pos="left">tag</span><?php } ?>
        ...
        <?php } ?>
        <?php if (count($list) == 0) { echo '<div class="NoArticle nanumgothic normal fz_15 lh_16 ls_2 ta_c" datano="no">게시물이 없습니다.</div>'; } ?>
</div>
            ...
            <?php if ($list_href || $is_checkbox || $write_href) { ?>
                <?php if ($list_href || $write_href) { ?>
                    ...
                    <div class="submit_btn">
                        <button type="submit" name="btn_submit" value="선택삭제" onclick="document.pressed=this.value" class="wpcf7-form-control wpcf7-submit txt btn_del" style="background:none; border:0;"><p class="list_btn nanumgothic medium ta_c ls_p2">선택삭제</p></button>
                    </div>
                    <?php } ?>
