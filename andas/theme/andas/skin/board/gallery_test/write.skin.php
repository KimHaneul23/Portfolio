                        ...
                        <div class="comments-form">
                            <div id="respond" class="comment-respond">
                                <form name="fwrite" id="fwrite" action="<?php echo $action_url ?>" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off" style="width:<?php echo $width; ?>">
                                    ...
                                    <div class="theme-form mt-3">
                                        <div class="form-group">
                                            <span class="tit fz_14">게시물 상단 이미지 (1장씩만 첨부되며, 최대 3장까지 등록 가능)</span>
                                            <div class="cont">
                                    ...
                                    <div class="theme-form mt-3">
                                        <div class="form-group">
                                            ...
                                            <div class="cont">
                                                <input multiple="multiple" type="file" name="bf_file[]" id="bf_file_2" title="파일첨부 2 : 용량 <?php echo $upload_max_filesize ?> 이하만 업로드 가능" class="form-control field txt" style="line-height:32px;">
                                            </div>
                                        </div>
                                        <?php if($w == 'u' && $file[2]['file']) { ?>
                                        <span class="file_del" style="font-size:11px;">
