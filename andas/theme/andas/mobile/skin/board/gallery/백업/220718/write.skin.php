                                ...
                                <form name="fwrite" id="fwrite" action="<?php echo $action_url ?>" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off" style="width:<?php echo $width; ?>" class="comment-form">
                                    ...
                                    <div class="bf_file_text">
                                        <p class="medium fz_14 ls_2">
                                            <span style="color:#ff0000;">★</span> 썸네일 이미지는 최대한 가로 : 410px, 세로 : 410px, 비율 : 1 x 1 로 업로드해 주시기 바랍니다!<br>
                                    ...
                                    <div class="theme-form mt-3">
                                        <div class="form-group">
                                            <span class="tit">상단 이미지(설명 옆에 보여질 이미지)</span>
                                            <div class="cont">
                                    ...
                                    <div class="theme-form mt-3">
                                        <div class="form-group">
                                            <span class="tit">큰 이미지(게시물 상단에 위치될 큰 사이즈의 이미지) - 최대 3개까지 등록 가능</span>
                                            <div class="cont">
                                    ...
                                    <?php for ($i=5; $is_file && $i<$file_count; $i++) { ?>
                                    <div class="theme-form mt-3">
                                        <div class="form-group">
                                            <span class="tit">슬라이드 이미지(게시물 큰 이미지 밑에 보여질 슬라이드 이미지 - 클릭 시 슬라이드로 확인 가능) - 최대  16개까지 등록 가능</span>
                                            <div class="cont">
                                                <input type="file" name="bf_file[]" id="bf_file_<?php echo $i ?>" title="파일첨부 <?php echo $i ?> : 용량 <?php echo $upload_max_filesize ?> 이하만 업로드 가능" class="form-control field txt" style="line-height:32px;">
                                            </div>
                                        </div>
                                        <?php if($w == 'u' && $file[$i]['file']) { ?>
                                        <span class="file_del" style="font-size:11px;">
                                            <input type="checkbox" id="bf_file_del<?php echo $i ?>" name="bf_file_del[<?php echo $i ?>]" value="<?php echo $i ?>"> <label for="bf_file_del<?php echo $i ?>"><?php echo $file[$i]['source'].'('.$file[$i]['size'].')';  ?> 파일 삭제</label>
                                        </span>
                                        <?php } ?>
                                    </div>
                                    <?php } ?>
