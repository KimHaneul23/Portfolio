...
function get_paging($write_pages, $cur_page, $total_page, $url, $add="")
{
    ...
    if ($cur_page > 1) $str .= '<a href="'.$url.($cur_page-1).$add.'" class="pg_page pg_prev"><span class="prev_icon"></span>PREVIOUS</a>'.PHP_EOL;
    ...
    if ($total_page > $cur_page) $str .= '<a href="'.$url.($cur_page+1).$add.'" class="pg_page pg_next">NEXT <span class="next_icon"></span></a>'.PHP_EOL;
