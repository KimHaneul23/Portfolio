...
<section>
    ...
    <div class="btn_list03 btn_list">
        <div class="gallery_btn_list" style="display:inline-block; margin:0 5px;">
            <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=gallery" target="_blank">포트폴리오 게시판 더보기</a>
        </div>
        <div class="online_btn_list" style="display:inline-block; margin:0 5px;">
            <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=online" target="_blank">온라인문의 게시판 더보기</a>
        </div>
    </div>
</section>
