...
define('G5_MYSQL_USER', 'gomturn81');
define('G5_MYSQL_PASSWORD', 'dnjsl0606@');
define('G5_MYSQL_DB', 'dbgomturn81');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'g5_');

//define('G5_TOKEN_ENCRYPTION_KEY', 'a24796964c7436c7dad9a81580028ada'); // 토큰 암호화에 사용할 키
