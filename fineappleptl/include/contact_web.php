    ...
    <div class="sub1_4_form_box">
        <div class="sub1_4_form">
            <form name="fwrite" id="fwrite" action="<?php echo G5_URL?>/bbs/write_update.php" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <input type="hidden" name="bo_table" value="contact_web">
                ...
                <input type="hidden" name="wr_content" value="홈페이지 제작 문의">
                ...
                <div class="contact_title_box">
                    <p class="txt01 fz_28 ls_p1 lh_16 pretendard normal">
                        홈페이지 제작 <span class="bold">문의하기</span>
                    </p>
                </div>
                ...
                <div class="contact_box_wrap contact_box_wrap02">
                    <div class="contact_box">
                        ...
                        <div class="contact_write_box contact_write_box02_4">
                            ...
                            <div>
                                <label for="wr_5_1" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input id="wr_5_1" type="radio" name="wr_5" value="원 페이지" <?php if($write['wr_5'] == '원 페이지') echo "checked='checked'"; ?> class="checkbox"><span></span>&nbsp;원 페이지 제작
                                </label>
                                <label for="wr_5_2" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input id="wr_5_2" type="radio" name="wr_5" value="전체 페이지" <?php if($write['wr_5'] == '전체 페이지') echo "checked='checked'"; ?> class="checkbox"><span></span>&nbsp;전체 페이지 제작
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="contact_box_wrap contact_box_wrap03 pc_cont_960">
                    <div class="contact_box">
                        <div class="contact_write_box contact_write_box03_1">
                            ...
                            <div>
                                <label for="wr_6_1_pc" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input id="wr_6_1_pc" type="radio" name="wr_6" value="신규" <?php if($write['wr_6'] == '신규') echo "checked='checked'"; ?> class="checkbox"><span></span>&nbsp;신규 제작
                                </label>
                                <label for="wr_6_2_pc" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input id="wr_6_2_pc" type="radio" name="wr_6" value="리뉴얼" <?php if($write['wr_6'] == '리뉴얼') echo "checked='checked'"; ?> class="checkbox"><span></span>&nbsp;기존 홈페이지 리뉴얼
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="contact_write_box contact_write_box03_2">
                            ...
                            <div>
                                <label for="wr_7_1_pc" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_1_pc" value="전체" onclick='selectAll(this)'><span></span>&nbsp;전체
                                </label>
                                <label for="wr_7_2_pc" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_2_pc" value="브랜딩" ><span></span>&nbsp;브랜딩
                                </label>
                                <label for="wr_7_3_pc" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_3_pc" value="기획" ><span></span>&nbsp;기획
                                </label>
                                <label for="wr_7_4_pc" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_4_pc" value="디자인" ><span></span>&nbsp;디자인
                                </label>
                                <label for="wr_7_5_pc" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_5_pc" value="프론트 개발" ><span></span>&nbsp;프론트 개발
                                </label>
                                <label for="wr_7_6_pc" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_6_pc" value="백엔드 개발(커스텀)" ><span></span>&nbsp;백엔드 개발(커스텀)
                                </label>
                            </div>
                            <div>
                                <label for="wr_7_7_pc" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_7_pc" value="홈페이지 원고" ><span></span>&nbsp;홈페이지 원고
                                </label>
                                <label for="wr_7_8_pc" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_8_pc" value="웹/모바일 적응형" ><span></span>&nbsp;웹/모바일 적응형
                                </label>
                                <label for="wr_7_9_pc" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_9_pc" value="웹/모바일 반응형" ><span></span>&nbsp;웹/모바일 반응형
                                </label>
                                <label for="wr_7_10_pc" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_10_pc" value="사진 촬영" ><span></span>&nbsp;사진 촬영
                                </label>
                                <label for="wr_7_11_pc" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_11_pc" value="영상 촬영" ><span></span>&nbsp;영상 촬영
                                </label>
                                <label for="wr_7_12_pc" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_12_pc" value="다국어페이지" ><span></span>&nbsp;다국어페이지
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="contact_box_wrap contact_box_wrap03 m_cont_960">
                    <div class="contact_box">
                        <div class="contact_write_box contact_write_box03_1">
                            <label for="wr_6" class="fz_20 ls_p1 lh_16 pretendard normal">제작방법을 선택해주세요</label>
                            <div>
                                <label for="wr_6_1_m" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input id="wr_6_1_m" type="radio" name="wr_6" value="신규" <?php if($write['wr_6'] == '신규') echo "checked='checked'"; ?> class="checkbox"><span></span>&nbsp;신규 제작
                                </label>
                                <label for="wr_6_2_m" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input id="wr_6_2_m" type="radio" name="wr_6" value="리뉴얼" <?php if($write['wr_6'] == '리뉴얼') echo "checked='checked'"; ?> class="checkbox"><span></span>&nbsp;기존 홈페이지 리뉴얼
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="contact_write_box contact_write_box03_2">
                            <label for="wr_7" class="fz_20 ls_p1 lh_16 pretendard normal">제작 시 필요한 항목을 선택해주세요 (중복선택 가능)</label>
                            <div>
                                <label for="wr_7_1_m" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_1_m" value="전체" onclick='selectAll(this)'><span></span>&nbsp;전체
                                </label>
                                <label for="wr_7_2_m" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_2_m" value="브랜딩" ><span></span>&nbsp;브랜딩
                                </label>
                                <label for="wr_7_3_m" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_3_m" value="기획" ><span></span>&nbsp;기획
                                </label>
                                <label for="wr_7_4_m" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_4_m" value="디자인" ><span></span>&nbsp;디자인
                                </label>
                                <label for="wr_7_5_m" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_5_m" value="프론트 개발" ><span></span>&nbsp;프론트 개발
                                </label>
                                <label for="wr_7_6_m" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_6_m" value="백엔드 개발(커스텀)" ><span></span>&nbsp;백엔드 개발(커스텀)
                                </label>
                                <label for="wr_7_7_m" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_7_m" value="홈페이지 원고" ><span></span>&nbsp;홈페이지 원고
                                </label>
                                <label for="wr_7_8_m" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_8_m" value="웹/모바일 적응형" ><span></span>&nbsp;웹/모바일 적응형
                                </label>
                                <label for="wr_7_9_m" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_9_m" value="웹/모바일 반응형" ><span></span>&nbsp;웹/모바일 반응형
                                </label>
                                <label for="wr_7_10_m" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_10_m" value="사진 촬영" ><span></span>&nbsp;사진 촬영
                                </label>
                                <label for="wr_7_11_m" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_11_m" value="영상 촬영" ><span></span>&nbsp;영상 촬영
                                </label>
                                <label for="wr_7_12_m" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_12_m" value="다국어페이지" ><span></span>&nbsp;다국어페이지
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="contact_agree_wrap">
                    ...
                    <label for="agree" class="agree fz_16 ls_p1 lh_16 pretendard light"><span class="bold" onclick='contact_agree_open()'>개인정보처리방침</span> 에 동의합니다.<i class="essential">*</i> (필수)</label>
...
<div class="s14_c02_wrap">
    <div class="s14_c02_section" id="s14_c02_section">
        <div class="s14_c02_cont" id="s14_c02_cont">
            <div class="s14_c02_title">
                <p class="txt01 fz_28 ls_p1 lh_16 pretendard normal">
                    홈페이지 제작 <span class="bold">프로세스</span>
                </p>
            </div>
            <div class="s14_c02_list_wrap" id="s14_c02_list_wrap">
                <ul class="s14_c02_list_ul s14_c02_list_ul_up">
                    ...
                    <li class="reveal fade-down delay_700 s14_c02_list_li s14_c02_list_li06">
                        <div class="s14_c02_list_text">
                            <p class="txt01 fz_25 ls_p1 lh_16 nanummyeongjo bold">
                                06
                            </p>
                ...
                <ul class="s14_c02_list_ul s14_c02_list_ul_down">
                    ...
                    <li class="reveal fade-up delay_800 s14_c02_list_li s14_c02_list_li07">
                        <div class="s14_c02_list_text">
                            <p class="txt01 fz_25 ls_p1 lh_16 nanummyeongjo bold">
                                07
                            </p>
