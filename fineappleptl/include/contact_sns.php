    ...
    <div class="sub1_4_form_box">
        <div class="sub1_4_form">
            <form name="fwrite" id="fwrite" action="<?php echo G5_URL?>/bbs/write_update.php" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <input type="hidden" name="bo_table" value="contact_sns">
                ...
                <input type="hidden" name="wr_content" value="SNS/마켓팅 제작 문의">
                ...
                <div class="contact_title_box">
                    <p class="txt01 fz_28 ls_p1 lh_16 pretendard normal">
                        SNS/마켓팅 제작 <span class="bold">문의하기</span>
                    </p>
                </div>
                ...
                <div class="contact_box_wrap contact_box_wrap02">
                    <div class="contact_box">
                        ...
                        <div class="contact_write_box contact_write_box02_4">
                            ...
                            <div>
                                <label for="wr_5_1_sns" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input id="wr_5_1_sns" type="radio" name="wr_5" value="원 페이지" <?php if($write['wr_5'] == '원 페이지') echo "checked='checked'"; ?> class="checkbox"><span></span>&nbsp;원 페이지 제작
                                </label>
                                <label for="wr_5_2_sns" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input id="wr_5_2_sns" type="radio" name="wr_5" value="전체 페이지" <?php if($write['wr_5'] == '전체 페이지') echo "checked='checked'"; ?> class="checkbox"><span></span>&nbsp;전체 페이지 제작
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="contact_box_wrap contact_box_wrap03 pc_cont_960">
                    <div class="contact_box">
                        <div class="contact_write_box contact_write_box03_1">
                            ...
                            <div>
                                <label for="wr_6_1_sns_pc" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input id="wr_6_1_sns_pc" type="radio" name="wr_6" value="신규" <?php if($write['wr_6'] == '신규') echo "checked='checked'"; ?> class="checkbox"><span></span>&nbsp;신규 제작
                                </label>
                                <label for="wr_6_2_sns_pc" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input id="wr_6_2_sns_pc" type="radio" name="wr_6" value="리뉴얼" <?php if($write['wr_6'] == '리뉴얼') echo "checked='checked'"; ?> class="checkbox"><span></span>&nbsp;기존 홈페이지 리뉴얼
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="contact_write_box contact_write_box03_2">
                            ...
                            <div>
                                <label for="wr_7_1_sns_pc" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_1_sns_pc" value="전체" onclick='selectAll(this)'><span></span>&nbsp;전체
                                </label>
                                <label for="wr_7_2_sns_pc" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_2_sns_pc" value="브랜딩" ><span></span>&nbsp;브랜딩
                                </label>
                                <label for="wr_7_3_sns_pc" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_3_sns_pc" value="기획" ><span></span>&nbsp;기획
                                </label>
                                <label for="wr_7_4_sns_pc" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_4_sns_pc" value="디자인" ><span></span>&nbsp;디자인
                                </label>
                                <label for="wr_7_5_sns_pc" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_5_sns_pc" value="프론트 개발" ><span></span>&nbsp;프론트 개발
                                </label>
                                <label for="wr_7_6_sns_pc" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_6_sns_pc" value="백엔드 개발(커스텀)" ><span></span>&nbsp;백엔드 개발(커스텀)
                                </label>
                            </div>
                            <div>
                                <label for="wr_7_7_sns_pc" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_7_sns_pc" value="홈페이지 원고" ><span></span>&nbsp;홈페이지 원고
                                </label>
                                <label for="wr_7_8_sns_pc" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_8_sns_pc" value="웹/모바일 적응형" ><span></span>&nbsp;웹/모바일 적응형
                                </label>
                                <label for="wr_7_9_sns_pc" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_9_sns_pc" value="웹/모바일 반응형" ><span></span>&nbsp;웹/모바일 반응형
                                </label>
                                <label for="wr_7_10_sns_pc" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_10_sns_pc" value="사진 촬영" ><span></span>&nbsp;사진 촬영
                                </label>
                                <label for="wr_7_11_sns_pc" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_11_sns_pc" value="영상 촬영" ><span></span>&nbsp;영상 촬영
                                </label>
                                <label for="wr_7_12_sns_pc" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_12_sns_pc" value="다국어페이지" ><span></span>&nbsp;다국어페이지
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="contact_box_wrap contact_box_wrap03 m_cont_960">
                    <div class="contact_box">
                        <div class="contact_write_box contact_write_box03_1">
                            <label for="wr_6" class="fz_20 ls_p1 lh_16 pretendard normal">제작방법을 선택해주세요</label>
                            <div>
                                <label for="wr_6_1_sns_m" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input id="wr_6_1_sns_m" type="radio" name="wr_6" value="신규" <?php if($write['wr_6'] == '신규') echo "checked='checked'"; ?> class="checkbox"><span></span>&nbsp;신규 제작
                                </label>
                                <label for="wr_6_2_sns_m" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input id="wr_6_2_sns_m" type="radio" name="wr_6" value="리뉴얼" <?php if($write['wr_6'] == '리뉴얼') echo "checked='checked'"; ?> class="checkbox"><span></span>&nbsp;기존 홈페이지 리뉴얼
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="contact_write_box contact_write_box03_2">
                            <label for="wr_7" class="fz_20 ls_p1 lh_16 pretendard normal">제작 시 필요한 항목을 선택해주세요 (중복선택 가능)</label>
                            <div>
                                <label for="wr_7_1_sns_m" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_1_sns_m" value="전체" onclick='selectAll(this)'><span></span>&nbsp;전체
                                </label>
                                <label for="wr_7_2_sns_m" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_2_sns_m" value="브랜딩" ><span></span>&nbsp;브랜딩
                                </label>
                                <label for="wr_7_3_sns_m" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_3_sns_m" value="기획" ><span></span>&nbsp;기획
                                </label>
                                <label for="wr_7_4_sns_m" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_4_sns_m" value="디자인" ><span></span>&nbsp;디자인
                                </label>
                                <label for="wr_7_5_sns_m" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_5_sns_m" value="프론트 개발" ><span></span>&nbsp;프론트 개발
                                </label>
                                <label for="wr_7_6_sns_m" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_6_sns_m" value="백엔드 개발(커스텀)" ><span></span>&nbsp;백엔드 개발(커스텀)
                                </label>
                                <label for="wr_7_7_sns_m" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_7_sns_m" value="홈페이지 원고" ><span></span>&nbsp;홈페이지 원고
                                </label>
                                <label for="wr_7_8_sns_m" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_8_sns_m" value="웹/모바일 적응형" ><span></span>&nbsp;웹/모바일 적응형
                                </label>
                                <label for="wr_7_9_sns_m" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_9_sns_m" value="웹/모바일 반응형" ><span></span>&nbsp;웹/모바일 반응형
                                </label>
                                <label for="wr_7_10_sns_m" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_10_sns_m" value="사진 촬영" ><span></span>&nbsp;사진 촬영
                                </label>
                                <label for="wr_7_11_sns_m" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_11_sns_m" value="영상 촬영" ><span></span>&nbsp;영상 촬영
                                </label>
                                <label for="wr_7_12_sns_m" class="fz_18 ls_p1 lh_16 pretendard normal">
                                    <input type="checkbox" name="ch_wr_7[]" id="wr_7_12_sns_m" value="다국어페이지" ><span></span>&nbsp;다국어페이지
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <script>
                    var f2_sns = document.fwrite;
                    var str2_sns=",<?php echo $write[wr_7]?>,";
                    for (var j_sns=0; j_sns<f2_sns.length; j_sns++) {
                        if (f2_sns.elements[j_sns].name == "ch_wr_7[]") {
                            if (str2_sns.indexOf(','+f2_sns.elements[j_sns].value+',')>=0) {
                                f2_sns.elements[j_sns].checked = true;
                            }
                        }
                    }
                ...
                <div class="contact_agree_wrap">
                    <input type="checkbox" id="agree_sns" name="agree_sns">
                    <label for="agree_sns" class="agree fz_16 ls_p1 lh_16 pretendard light"><span class="bold" onclick='contact_agree_open()'>개인정보처리방침</span> 에 동의합니다.<i class="essential">*</i> (필수)</label>
            ...
            <script>
                ...
                function fwrite_submit(f)
                {
                    ...
                    if ( $('input:checkbox[name="agree_sns"]').is(":checked") == false) {
...
<div class="s14_c02_wrap">
    <div class="s14_c02_section" id="s14_c02_section3">
        <div class="s14_c02_cont" id="s14_c02_cont3">
            <div class="s14_c02_title">
                <p class="txt01 fz_28 ls_p1 lh_16 pretendard normal">
                    SNS/마켓팅 제작 <span class="bold">프로세스</span>
                </p>
            </div>
            <div class="s14_c02_list_wrap" id="s14_c02_list_wrap3">
