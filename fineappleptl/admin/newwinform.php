...
<form name="frmnewwin" action="./newwinformupdate.php" onsubmit="return frmnewwin_check(this);" method="post">
    ...
    <div class="local_desc01 local_desc">
		...
		<p>팝업 노출 갯수는 <strong>최대 5개</strong>입니다.</p>
    </div>
		...
		<table>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<input type="text" name="nw_href" value="<?php echo get_sanitize_input($nw['nw_href']); ?>" id="nw_href" class="frm_input" size="80">
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="nw_content">내용</label></th>
					<td>
						<span class="frm_info">pc 이미지 크기는 <strong>넓이 1000픽셀 높이 470픽셀</strong>로 해주세요.</span>
						<span class="frm_info">mobile 이미지 크기는 <strong>넓이 800픽셀 높이 935픽셀</strong>로 해주세요.</span>
