...
<form name="fconfigform" id="fconfigform" method="post" onsubmit="return fconfigform_submit(this);">
    ...
    <section id="anc_cf_basic">
        <h2 class="h2_frm">병원 기본 설정</h2>

        <div class="tbl_frm01 tbl_wrap">
            <table>
                <caption>병원 기본 설정</caption>
				<colgroup>
					<col style="width:15%">
					<col>
				</colgroup>
                <tbody>
					...
					<tr>
						<th scope="row"><label for="cf_1">상호명<strong class="sound_only">필수</strong></label></th>
						<td colspan="3"><input type="text" name="cf_1" value="<?php echo get_sanitize_input($config['cf_1']); ?>" id="cf_1" required class="required frm_input" size="40"></td>
					</tr>
					<tr>
						<th scope="row"><label for="cf_3">대표이메일</label></th>
						<td colspan="3"><input type="text" name="cf_3" value="<?php echo get_sanitize_input($config['cf_3']); ?>" id="cf_3" class="frm_input" size="40"></td>
					</tr>
					<tr>
						<th scope="row"><label for="cf_5">대표번호<strong class="sound_only">필수</strong></label></th>
						<td colspan="3"><input type="text" name="cf_5" value="<?php echo get_sanitize_input($config['cf_5']); ?>" id="cf_5" required class="required frm_input" size="40"></td>
					</tr>
					<tr>
						<th scope="row"><label for="cf_4">대표FAX</label></th>
    ...
    <section id="anc_cf_board" class="hide">
        <h2 class="h2_frm">게시판 기본 설정</h2>
        <div class="local_desc02 local_desc">
            <p>각 게시판 관리에서 개별적으로 설정 가능합니다.</p>
        </div>

        <div class="tbl_frm01 tbl_wrap" class="hide">
            <table>
    ...
    <section id="anc_cf_join">
        ...
        <div class="local_desc02 local_desc">
            <p>회원가입 시 필요한 정보 등을 설정할 수 있습니다.</p>
        </div>
    ...
    <section id="anc_cf_cert" class="hide">
...
-->
    ...
    <section id="anc_cf_mail" class="hide">
    ...
    <section id="anc_cf_article_mail" class="hide">
    ...
    <section id="anc_cf_join_mail" class="hide">
    ...
    <section id="anc_cf_vote_mail" class="hide">
    ...
    <section id="anc_cf_sms" class="hide">
