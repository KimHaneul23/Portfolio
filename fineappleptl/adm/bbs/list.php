...
$write_pages = get_paging(G5_IS_MOBILE ? $config['cf_mobile_pages'] : $config['cf_write_pages'], $page, $total_page, G5_ADMIN_BBS_URL.'/board.php?bo_table='.$bo_table.'&'.$qstr.'&amp;page=');

$list_href = '';
$prev_part_href = '';
$next_part_href = '';
if ($is_search_bbs) {
	$list_href = G5_ADMIN_BBS_URL.'/board.php?bo_table='.$bo_table;
...
//        $prev_part_href = get_pretty_url($bo_table,0,$qstr1.'&amp;spt='.$prev_spt.'&amp;page=1');
		$prev_part_href = G5_ADMIN_BBS_URL.'/board.php?bo_table='.$bo_table.'&'.$qstr1.'&amp;spt='.$prev_spt.'&amp;page=1';
...
//        $next_part_href = get_pretty_url($bo_table,0,$qstr1.'&amp;spt='.$next_spt.'&amp;page=1');
		$next_part_href = G5_ADMIN_BBS_URL.'/board.php?bo_table='.$bo_table.'&'.$qstr1.'&amp;spt='.$next_spt.'&amp;page=1';
