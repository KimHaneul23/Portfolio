...
if ($_GET['bo_table'] == 'notice') {
	...
	$sub_menu = "400800";
}else if($_GET['bo_table'] == 'research') {
	$sub_menu = "600100";
}else if($_GET['bo_table'] == 'vitiligo_healingstor') {
	$sub_menu = "600200";
}else if($_GET['bo_table'] == 'vitiligo_review') {
	$sub_menu = "600300";
}else if($_GET['bo_table'] == 'vitiligo_counselling') {
	$sub_menu = "600400";
}
