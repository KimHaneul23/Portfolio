<?php
//exec
function execGa($analytics, $site_id, $startDate, $endDate, $metrics, $dimensions, $sort = false, $filter = false, $cnt = false, $name='', $startIndex=1)
{
	
	
	$pvData = getData($analytics, $site_id, $startDate, $endDate, $metrics, $dimensions, $sort, $filter, $cnt, $name, $startIndex);
...
function getData( $analytics, $site_id, $startDate, $endDate, $metrics, $dimensions = false, $sort = false, $filter = false, $maxresult = false, $name = '', $startIndex=1  ) 
{
	$ids = 'ga:'.$site_id; 

	$optParams = array();
	$optParams['dimensions'] = $dimensions;
	$optParams['start-index'] = $startIndex;
