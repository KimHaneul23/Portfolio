...
class __TwigTemplate_fc1a409cf0edb63b2111351cd65db7a41b06a363f1cdd4bb3162145c648e3198 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Your preferences will be saved for current session only. Storing them permanently requires %sphpMyAdmin configuration storage%s.");
    ...
    {
        return new Source("", "preferences/header.twig", "/ptldesign/www/dbeditor/templates/preferences/header.twig");
    }
}
