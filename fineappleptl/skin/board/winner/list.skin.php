...
<h1 id="container_title"><?php echo $board['bo_subject'] ?><span style="font-size:15px; font-weight:400;"> - 메인페이지 두번째 영역에서 보여지는 수상작</span></h1>
		...
		<table>
			...
			<thead>
				<tr>
					...
					<th scope="col">제작형태</th>
					<th scope="col">수상연도</th>
				...
				<tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?> <?php echo $lt_class ?>">
					...
					<td class="td_subject">
						...
						<a href="./write.php?w=u&bo_table=<?php echo $bo_table?>&wr_id=<?php echo $list[$i]['wr_id'] ?>&page=<?php echo $page ?>">
				            ...
				            ?>
							<span style="font-weight:600;"><?php echo $list[$i]['subject'] ?></span>
						</a>
					</td>
					<td>
