...
if($bo_table == 'projects'){
    goto_url(short_url_clean(G5_URL.'/admin/board.php?bo_table='.$bo_table.'&amp;page='.$page.$qstr));
} else if($bo_table == 'winner'){
    goto_url(short_url_clean(G5_URL.'/admin/board.php?bo_table='.$bo_table.'&amp;page='.$page.$qstr));
} else if($bo_table == 'contact_web'){
    goto_url(short_url_clean(G5_URL.'/admin/board.php?bo_table='.$bo_table.'&amp;page='.$page.$qstr));
} else if($bo_table == 'contact_media'){
    goto_url(short_url_clean(G5_URL.'/admin/board.php?bo_table='.$bo_table.'&amp;page='.$page.$qstr));
} else if($bo_table == 'contact_sns'){
    goto_url(short_url_clean(G5_URL.'/admin/board.php?bo_table='.$bo_table.'&amp;page='.$page.$qstr));
} else if($bo_table == 'contact_design'){
    goto_url(short_url_clean(G5_URL.'/admin/board.php?bo_table='.$bo_table.'&amp;page='.$page.$qstr));
} else {
    goto_url(short_url_clean(G5_URL.'/admin/board.php?bo_table='.$bo_table.'&amp;page='.$page.$qstr));
}
