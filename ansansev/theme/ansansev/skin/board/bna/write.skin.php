...
<div id="bo_title" style="width:60%; margin:160px auto 0; padding:100px 0 0;">
	<?php echo $board['bo_subject'] ?>
</div>
<div class="bo_fx" style="width:60%; margin:0 auto; padding:40px 0;"></div>
<!-- 게시물 읽기 시작 { -->
<section id="bo_w" style="width:60%; margin:0 auto; padding:0 0 100px;">
    ...
    <div class="bbs_head02 bbs_wrap">
		...
		<tr>
			...
			<td colspan='3' class='bf_file_td'>
				...
				<input type="text" title="파일 첨부하기" class="bf_file_text" value='사진은 350x525 으로 맞춰주세요' readonly="readonly" size="29" style="color:#9c9c9c">
				<input type="file" name="bf_file[]" title="파일첨부 <?php echo $i+1 ?> :  용량 <?php echo $upload_max_filesize ?> 이하만 업로드 가능" class="frm_file frm_input" style="display:inline-block;cursor:pointer;z-index: 1;">
				...
				<input type="checkbox" id="bf_file_del<?php echo $i ?>" name="bf_file_del[<?php echo $i;  ?>]" value="1"> <label for="bf_file_del<?php echo $i ?>" style="position: relative;top: 1px;left: 15px;width: 448px;height: 28px;line-height: 28px;z-index: 1;background: #fff;"><?php echo $file[$i]['source'].'('.$file[$i]['size'].')';  ?> 파일 삭제</label>
				<?php }  ?>
			</td>
		</tr>
		<?php }?>
